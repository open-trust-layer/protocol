...
- Add Specification 0013 covering versioning, registries, extension governance, reason-code governance, migration rules, capability stability, and the Draft v0.2 independently verified core.
...
- Record accepted Milestone 17 evidence: Python 62/62, Rust 62/62, and Python↔Rust 9/9.
